...
docker run -d --name dynamodb -p 9520:8000 amazon/dynamodb-local
...
AWS_REGION=foobar AWS_ACCESS_KEY_ID=foobar AWS_SECRET_ACCESS_KEY=foobar aws --endpoint-url http://localhost:9520 dynamodb put-item --table-name Table --item '{"userId":{"S":"Event-1"},"groupId":{"S":"Event-1"},"code":{"S":"1"},"place":{"M":{"googlePlaceId":{"S":"ChIJ7VHBwnZ644kRKRWP5Qe27v4"}}},"eventName":{"S":"Royale"}}'
